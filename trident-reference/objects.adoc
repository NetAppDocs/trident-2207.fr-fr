...
== Objets de volume persistant Kubernetes
...
== Objets de classe de stockage Kubernetes
...
| Volume Bindingmode | chaîne | Immédiat, WaitForFirstConsumer | Sélectionnez le moment où la liaison des volumes et le provisionnement dynamique se produisent | Tout | 1.19 - 1.24 
|===
[TIP]
====
...
== Objets Kubernetes VolumeContent
...
== Objets StoragePool pour Trident
...
== Objet Resourcequota Astra Trident
